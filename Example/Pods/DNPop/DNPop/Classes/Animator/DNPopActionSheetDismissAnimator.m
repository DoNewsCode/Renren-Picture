//
//  DNPopActionSheetDismissAnimator.m
//  DNPop
//
...
@implementation DNPopActionSheetDismissAnimator
...
- (void)slideDownAnimationWithContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:duration
                     animations:^{
                         fromVC.backgroundView.alpha = 0;
                         fromVC.alertView.frame = (CGRect){fromVC.alertView.frame.origin.x,fromVC.view.frame.size.height,fromVC.alertView.frame.size};
                     }
                     completion:^(BOOL finished) {
                         [transitionContext completeTransition:YES];
                     }];
