//
//  DRIPictureBrowsePercentDrivenInteractive.m
...
@interface DRIPictureBrowsePercentDrivenInteractive ()
...
@implementation DRIPictureBrowsePercentDrivenInteractive
...
- (instancetype)initWithTransitionParameter:(DRIPictureBrowseTransitionParameter *)transitionParameter{
...
- (CGFloat)percentForGesture:(UIPanGestureRecognizer *)gesture
{
    ...
    CGFloat moved = (translation.y / SCREENHEIGHT);
    return 1 - fabs(moved);
//    if (moved < 1 && moved > 0) {
//    }else{
//        
...
//    NSLog(@"originScale ==== %f",scale);
//    scale = scale < 0 ? 0 : scale;
//    scale = scale > 1 ? 1 : scale;
//    NSLog(@"changedScale ==== %f",scale);
//    
//    return scale;
}
