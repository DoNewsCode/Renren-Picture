...
@interface DRIMotionManager()
@property (nonatomic ,strong) CMMotionManager *motionManager;
@end
@implementation DRIMotionManager
+ (instancetype)sharedManager{
    static DRIMotionManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[DRIMotionManager alloc]init];
    });
    return manager;
}
- (instancetype)init{
...
- (AVCaptureVideoOrientation)currentVideoOrientation{
    ...
    switch ([DRIMotionManager sharedManager].deviceOrientation) {
