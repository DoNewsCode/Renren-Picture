...
@interface DRIPictureBrowsePopAnimator ()

@end

@implementation DRIPictureBrowsePopAnimator
...
//    if (fromViewController.modalPresentationStyle == UIModalPresentationFullScreen || fromViewController.navigationController.modalPresentationStyle == UIModalPresentationFullScreen) {
