...
@end
@implementation DRIRecordEncoder

+ (DRIRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate{
    DRIRecordEncoder* enc = [DRIRecordEncoder alloc];
...
- (CGAffineTransform)transformFromCurrentVideoOrientationToOrientation:(AVCaptureVideoOrientation)orientation
{
    ...
    CGFloat videoOrientationAngleOffset = [self angleOffsetFromPortraitOrientationToOrientation:[DRIMotionManager sharedManager].videoOrientation];
