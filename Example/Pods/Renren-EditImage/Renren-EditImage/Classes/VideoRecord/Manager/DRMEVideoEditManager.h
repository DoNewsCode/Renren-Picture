...
#import "DRMEAVSEGearboxCommandModel.h"

typedef NS_ENUM(NSUInteger,DRMEVideoExportRatio) {
    DRMEVideoExportRatioLowQuality,// 低分辩率
    DRMEVideoExportRatioMediumQuality,// 中等分辩率
    DRMEVideoExportRatioHighQuality, // 高分辩率
    DRMEVideoExportRatio640x480,
    DRMEVideoExportRatio960x540,
    DRMEVideoExportRatio1280x720
};
...
@interface DRMEVideoEditManager : NSObject

#pragma mark 输出设置
/**
 输出的视频分辨率,默认为960 * 540,需要在appendVideo前调用，若已经有视频在里面，设置无效
 */
@property (nonatomic , assign) DRMEVideoExportRatio ratio;
