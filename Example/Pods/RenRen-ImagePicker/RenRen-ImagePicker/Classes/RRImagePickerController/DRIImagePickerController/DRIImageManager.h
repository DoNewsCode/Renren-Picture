...
@class DRIAlbumModel,DRIAssetModel;
@protocol DRIImagePickerControllerDelegate;
@interface DRIImageManager : NSObject
...
@property (weak, nonatomic) id<DRIImagePickerControllerDelegate> pickerDelegate;
...
- (void)getAllAlbums:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage needFetchAssets:(BOOL)needFetchAssets completion:(void (^)(NSArray<DRIAlbumModel *> *models))completion;
...
- (void)getAssetsFromFetchResult:(PHFetchResult *)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage cameraRoll:(BOOL)isCameraRoll completion:(void (^)(NSArray<DRIAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(PHFetchResult *)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(DRIAssetModel *model))completion;

/// Get photo 获得照片
- (PHImageRequestID)getPostImageWithAlbumModel:(DRIAlbumModel *)model completion:(void (^)(UIImage *postImage))completion;
...
//@interface DRISortDescriptor : NSSortDescriptor
//
//@end
