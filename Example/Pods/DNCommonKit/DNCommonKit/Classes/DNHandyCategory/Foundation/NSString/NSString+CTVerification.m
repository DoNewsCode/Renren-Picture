//
//  NSString+CTVerification.m
//  DNCommonKit
//
//  Created by Ming on 2020/7/24.
//

#import "NSString+CTVerification.h"

@implementation NSString (CTVerification)

+ (BOOL)ct_ValidateChinaMobileString:(NSString *)mobileString {
    return [mobileString ct_ValidateChinaMobile];
}
...
+ (BOOL)ct_ValidateChinaIDCardNumberString:(NSString *)cardNumberString {
    return [cardNumberString ct_ValidateChinaIDCardNumber];
}
