...
@interface DRIRecordProgressView()
@property (nonatomic ,strong) CALayer *centerlayer;
@end
@implementation DRIRecordProgressView
...
- (void)setupUI{
    ...
    centerlayer.bounds = CGRectMake(0, 0, 62, 62);
    centerlayer.cornerRadius = 62/2;
...
- (void)setScale{
    [UIView animateWithDuration:0.25 animations:^{
        _centerlayer.transform = CATransform3DScale(_centerlayer.transform, 32/62.0, 32/62.0, 1);
        self.transform = CGAffineTransformScale(self.transform, 114/86.f, 114/86.f);
    }];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    [[UIColor colorWithRed:18/255.0 green:100/255.0 blue:179/255.0 alpha:1] setStroke];// 设置线颜色
