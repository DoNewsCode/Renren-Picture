...
#import "NSString+CTQRCode.h"

@implementation NSString (CTQRCode)

+ (UIImage *)ct_codeImageWithString:(NSString *)string size:(CGFloat)width
{
    CIImage *ciImage = [self createQRForString:string];
    if (ciImage) {
        return [self createNonInterpolatedUIImageFormCIImage:ciImage
                                                        size:width];
    } else {
        return nil;
    }
...
+ (UIImage *)ct_codeImageWithString:(NSString *)string
                            size:(CGFloat)width
                           color:(UIColor *)color;
{
    
    
    UIImage *image = [self ct_codeImageWithString:string size:width];
    if (color) {
...
{
    UIImage *bgImage = [self ct_codeImageWithString:string
                                            size:width
                                           color:color];
