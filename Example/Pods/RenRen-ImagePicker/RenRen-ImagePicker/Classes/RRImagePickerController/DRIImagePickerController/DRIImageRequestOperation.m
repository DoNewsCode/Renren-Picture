...
@implementation DRIImageRequestOperation
...
- (void)start {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        [[DRIImageManager manager] NewGetPhotoWithAsset:self.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
