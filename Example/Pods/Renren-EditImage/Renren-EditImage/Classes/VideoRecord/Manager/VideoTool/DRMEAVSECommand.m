...
NSString *const DRMEAVSEExportCommandCompletionNotification = @"DRMEAVSEExportCommandCompletionNotification";
NSString* const DRMEAVSEExportCommandError = @"DRMEAVSEExportCommandError";


@interface DRMEAVSECommand ()
...
@implementation DRMEAVSECommand

- (instancetype)init{
    return [self initWithComposition:[DRMEAVSEComposition new]];
}
